<?php 
	...
	class CompetitorRepositoryBase  {
		protected $_pdo;
		protected $_lang;
		...
		public static function getAll($Connection) {
			...
			$query = $qb->select()->from(array("competitor"))->getQuery();
			try {
				$result = $Connection->selectTable($query);
				$array = array();
				foreach ($result as $object){
					$o = new Entity\Competitor();
					$o->fillObject($object);
					$array[] = $o;
				}
				return $array;
		...
		public function delete($id) {
			$query = $this->_queryBuilder->delete("competitor")
		...
		public function add($properties) {
			$query = $this->_queryBuilder->insert("competitor", array('name' => $properties["name"], 'date' => $properties["date"], ))->getQuery();
			try {
				return $this->_pdo->Query($query);
			}
			catch(PDOException $e){
		...
		public function update($id, $properties) {
			$query = $this->_queryBuilder->update("competitor", array('name' => $properties["name"], 'date' => $properties["date"], ))->where(array(array("link" => "", "left" => "id", "operator" => "=", "right" => $id )))->getQuery();
			try {
				return $this->_pdo->Query($query);
			}
			catch(PDOException $e){
